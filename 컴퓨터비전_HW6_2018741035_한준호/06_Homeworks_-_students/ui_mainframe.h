...
public:
    ...
    QLabel *label;
    QLabel *label_2;
    QDoubleSpinBox *doubleSpinSigma;
    QLabel *label_3;
    QWidget *tab_3;
    QWidget *tab_4;
    QWidget *tab;
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        ButtonCannyEdge = new QPushButton(tab_2);
        ButtonCannyEdge->setObjectName(QString::fromUtf8("ButtonCannyEdge"));
        ButtonCannyEdge->setGeometry(QRect(30, 60, 231, 41));
        SpinLow = new QSpinBox(tab_2);
        SpinLow->setObjectName(QString::fromUtf8("SpinLow"));
        SpinLow->setGeometry(QRect(60, 110, 71, 32));
        SpinLow->setMaximum(255);
        SpinLow->setSingleStep(5);
        SpinHigh = new QSpinBox(tab_2);
        SpinHigh->setObjectName(QString::fromUtf8("SpinHigh"));
        SpinHigh->setGeometry(QRect(190, 110, 71, 32));
        SpinHigh->setMaximum(255);
        SpinHigh->setSingleStep(5);
        label = new QLabel(tab_2);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(30, 110, 31, 24));
        label_2 = new QLabel(tab_2);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(160, 110, 31, 24));
        doubleSpinSigma = new QDoubleSpinBox(tab_2);
        doubleSpinSigma->setObjectName(QString::fromUtf8("doubleSpinSigma"));
        doubleSpinSigma->setGeometry(QRect(140, 140, 71, 31));
        doubleSpinSigma->setMaximum(10.000000000000000);
        doubleSpinSigma->setSingleStep(0.100000000000000);
        label_3 = new QLabel(tab_2);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(100, 140, 41, 31));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        ButtonCannyEdge->setText(QApplication::translate("MainFrame", "Canny Edge Operator", nullptr));
        label->setText(QApplication::translate("MainFrame", "Low", nullptr));
        label_2->setText(QApplication::translate("MainFrame", "High", nullptr));
        label_3->setText(QApplication::translate("MainFrame", "Sigma", nullptr));
