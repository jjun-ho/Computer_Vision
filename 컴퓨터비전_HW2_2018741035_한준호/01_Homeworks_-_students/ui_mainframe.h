...
public:
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        ButtonThres = new QPushButton(tab_2);
        ButtonThres->setObjectName(QString::fromUtf8("ButtonThres"));
        ButtonThres->setGeometry(QRect(70, 40, 141, 41));
        ButtonOtsu = new QPushButton(tab_2);
        ButtonOtsu->setObjectName(QString::fromUtf8("ButtonOtsu"));
        ButtonOtsu->setGeometry(QRect(70, 150, 141, 41));
        label = new QLabel(tab_2);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(110, 90, 16, 20));
        spinT = new QSpinBox(tab_2);
        spinT->setObjectName(QString::fromUtf8("spinT"));
        spinT->setGeometry(QRect(120, 90, 61, 22));
        spinT->setMaximum(255);
        spinT->setSingleStep(10);
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        ButtonThres->setText(QApplication::translate("MainFrame", "Thresholding", nullptr));
        ButtonOtsu->setText(QApplication::translate("MainFrame", "Otsu's Thresholing", nullptr));
        label->setText(QApplication::translate("MainFrame", "T", nullptr));
