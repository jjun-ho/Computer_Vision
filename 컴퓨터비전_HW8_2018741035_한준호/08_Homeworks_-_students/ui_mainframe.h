...
public:
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        spinOptical = new QSpinBox(tab_2);
        spinOptical->setObjectName(QString::fromUtf8("spinOptical"));
        spinOptical->setGeometry(QRect(170, 90, 56, 31));
        spinOptical->setMinimum(1);
        spinOptical->setMaximum(16);
        ButtonOpticalFlow = new QPushButton(tab_2);
        ButtonOpticalFlow->setObjectName(QString::fromUtf8("ButtonOpticalFlow"));
        ButtonOpticalFlow->setGeometry(QRect(70, 130, 181, 31));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        ButtonOpticalFlow->setText(QApplication::translate("MainFrame", "Optical Flows", nullptr));
        label->setText(QApplication::translate("MainFrame", "Target", nullptr));
