...
public:
    ...
    QPushButton *buttonHue;
    QPushButton *buttonSaturation;
    QPushButton *buttonValue;
    QLabel *label;
    QLabel *label_2;
    QWidget *tab_3;
    QWidget *tab_4;
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        buttonSepiaTone->setGeometry(QRect(80, 40, 141, 31));
        spinHue = new QSpinBox(tab_2);
        spinHue->setObjectName(QString::fromUtf8("spinHue"));
        spinHue->setGeometry(QRect(80, 80, 51, 22));
        ...
        spinSaturation->setGeometry(QRect(170, 80, 51, 22));
        spinSaturation->setMaximum(1.000000000000000);
        spinSaturation->setSingleStep(0.100000000000000);
        buttonHue = new QPushButton(tab_2);
        buttonHue->setObjectName(QString::fromUtf8("buttonHue"));
        buttonHue->setGeometry(QRect(10, 120, 80, 20));
        buttonSaturation = new QPushButton(tab_2);
        buttonSaturation->setObjectName(QString::fromUtf8("buttonSaturation"));
        buttonSaturation->setGeometry(QRect(110, 120, 80, 20));
        buttonValue = new QPushButton(tab_2);
        buttonValue->setObjectName(QString::fromUtf8("buttonValue"));
        buttonValue->setGeometry(QRect(210, 120, 80, 20));
        label = new QLabel(tab_2);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(60, 80, 21, 16));
        label_2 = new QLabel(tab_2);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(150, 80, 21, 16));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        buttonSepiaTone->setText(QApplication::translate("MainFrame", "Sepia Tone", nullptr));
        buttonHue->setText(QApplication::translate("MainFrame", "H", nullptr));
        buttonSaturation->setText(QApplication::translate("MainFrame", "S", nullptr));
        buttonValue->setText(QApplication::translate("MainFrame", "V", nullptr));
        label->setText(QApplication::translate("MainFrame", "Hue", nullptr));
        label_2->setText(QApplication::translate("MainFrame", "Sat", nullptr));
