...
public:
    ...
    QWidget *tab_2;
    QPushButton *ButtonNoiseAdd;
    QPushButton *ButtonBox;
    QPushButton *ButtonGaussian;
    QPushButton *ButtonMedian;
    QLabel *label;
    QLabel *label_2;
    QDoubleSpinBox *GaussianSigma;
    QLabel *label_3;
    QDoubleSpinBox *BoxSigma;
    QDoubleSpinBox *MedianSize;
    QWidget *tab_3;
    QWidget *tab_4;
    QWidget *tab;
    QWidget *tab_5;
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        ButtonNoiseAdd = new QPushButton(tab_2);
        ButtonNoiseAdd->setObjectName(QString::fromUtf8("ButtonNoiseAdd"));
        ButtonNoiseAdd->setGeometry(QRect(80, 40, 151, 51));
        ButtonBox = new QPushButton(tab_2);
        ButtonBox->setObjectName(QString::fromUtf8("ButtonBox"));
        ButtonBox->setGeometry(QRect(40, 110, 221, 31));
        ButtonGaussian = new QPushButton(tab_2);
        ButtonGaussian->setObjectName(QString::fromUtf8("ButtonGaussian"));
        ButtonGaussian->setGeometry(QRect(40, 190, 221, 31));
        ButtonMedian = new QPushButton(tab_2);
        ButtonMedian->setObjectName(QString::fromUtf8("ButtonMedian"));
        ButtonMedian->setGeometry(QRect(40, 270, 221, 31));
        label = new QLabel(tab_2);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(60, 140, 61, 24));
        label_2 = new QLabel(tab_2);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(60, 220, 61, 24));
        GaussianSigma = new QDoubleSpinBox(tab_2);
        GaussianSigma->setObjectName(QString::fromUtf8("GaussianSigma"));
        GaussianSigma->setGeometry(QRect(130, 220, 91, 31));
        GaussianSigma->setMaximum(5.000000000000000);
        GaussianSigma->setSingleStep(0.100000000000000);
        label_3 = new QLabel(tab_2);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(60, 300, 61, 24));
        BoxSigma = new QDoubleSpinBox(tab_2);
        BoxSigma->setObjectName(QString::fromUtf8("BoxSigma"));
        BoxSigma->setGeometry(QRect(130, 140, 91, 31));
        BoxSigma->setMaximum(5.000000000000000);
        BoxSigma->setSingleStep(0.100000000000000);
        MedianSize = new QDoubleSpinBox(tab_2);
        MedianSize->setObjectName(QString::fromUtf8("MedianSize"));
        MedianSize->setGeometry(QRect(130, 300, 91, 31));
        MedianSize->setMinimum(1.000000000000000);
        MedianSize->setMaximum(9.000000000000000);
        MedianSize->setSingleStep(1.000000000000000);
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        ButtonNoiseAdd->setText(QApplication::translate("MainFrame", "Noise Image", nullptr));
        ButtonBox->setText(QApplication::translate("MainFrame", "Box Filtering", nullptr));
        ButtonGaussian->setText(QApplication::translate("MainFrame", "Gaussian Filtering", nullptr));
        ButtonMedian->setText(QApplication::translate("MainFrame", "Median Filtering", nullptr));
        label->setText(QApplication::translate("MainFrame", "Sigma", nullptr));
        label_2->setText(QApplication::translate("MainFrame", "Sigma", nullptr));
        label_3->setText(QApplication::translate("MainFrame", "Size", nullptr));
